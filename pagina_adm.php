...
<script>
  function funcion_primera(){  alertify.success("Bienvenido Señor Administrador <?php echo$_SESSION["nombre"] ?>");}
...
<div class="col-sm-6 col-md-2" id="menu"   style="background:#11A8D4" >
 ...
 <img id="profile-img" class="profile-img-card" src="img/los.jpg" />
 
  
<strong><center> <h1 style="color:#FFF" ></h1> <span style="color:#FFF"> Bienvenido(a) </span></center><input class="form-control" type="text"  value="<?php echo$_SESSION["nombre"] ?>" disabled></strong>
...
<div class="form-group">  
 ...
 <div class="form-group">
    <a style="color:#33CAFF"  href="index.php" > <h3 class=" glyphicon glyphicon-save-file" style="color:#FFF" ></h3>    <span  style="color:#FFF">Generar Factura </a><br>
  </div>
 ...
 <div class="container-fluid">
  <div class="row">
      ...
      <div id="logo">
        ...
        <h1  class="glyphicon glyphicon-pencil" style="color:#11A8D4"> FORMULARIO DE REGISTRO</h1>
 ...
 <div class="container-fluid">
  <div class="row">
    ...
    <fieldset>
        ...
        <h1  class="glyphicon glyphicon-pencil" style="color:#11A8D4"> FORMULARIO DE ACTIVACION</h1>
...
<!-- Incapacidad medica -->
 ...
 <div class="container-fluid">
  <div class="row">
        ...
        <h1  class="glyphicon glyphicon-object-align-bottom" style="color:#11A8D4"> INCAPACIDAD  MEDICA</h1>
...
<div class="bootstrap-iso formulario  col-sm-6 col-md-6  col-md-offset-4" id="uno">
 <div class="container-fluid">
  <div class="row">
<center>
         <div id="logo">
        ...
        <h1  class="glyphicon glyphicon-object-align-bottom" style="color:#11A8D4"> AGREGAR CITA</h1>
</center>
...
$entrar= $con -> query("SELECT id,fecha,tipo,estado,hora,doctor,cedula FROM citas ORDER BY fecha DESC");
...
?>
 <tr class="btn-primary" style="background:#11A8D4" >
    ...
    <th>
      ...
      <button type="button" value="<?php echo $x; ?>" name="act"  id="id" style="background:#11A8D4" onclick="actestado();"><b style="color:#fff"> <span class="glyphicon glyphicon-ok-circle" ></span></button>
...
<!--HACER ACTUALIZACIONES DE DATOS-->
      ...
      <form method='post' action="pagina_adm.php" >
