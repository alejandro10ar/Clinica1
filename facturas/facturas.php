...
//logo de la tienda
$pdf->Image('../img/sis.jpg' , 0 ,0, 50 , 50,'jpg', 'http://php-estudios.blogspot.com');
...
"Ciudad: ".$poblacion_tienda."\n".
"Departamento: ".$provincia_tienda."\n".
...
"Ciudad: ".$poblacion_cliente."\n".
"Departamento: ".$provincia_cliente."\n".
"Código Postal: ".$codigo_postal_cliente."\n".
"Identificación Cliente: ".$identificacion_fiscal_cliente, 
0, // bordes 0 = no | 1 = si
"J", // texto justificado
false);
...
$total_mas_iva = round($precio_subtotal + $add_iva + $gastos_de_envio, 1);
