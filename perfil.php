...
<script>
		function upload_image(){
				...
				if( (typeof file === "object") && (file !== null) )
				{
					...
					$.ajax({
						url: "ajax/imagen_ajax.php", // Url a la cual se envía la solicitud
						type: "POST",            // Tipo de solicitud para enviar, llamada como método
						...
						cache: false,             // No se puede solicitar el almacenamiento en caché de las páginas
