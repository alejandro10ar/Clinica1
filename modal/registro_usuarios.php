		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax"></div>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-8">
				  <input type="password" class="form-control" id="user_password_new" name="user_password_new" placeholder="Contraseña" pattern=".{4,}" title="Contraseña ( min . 4 caracteres)" required>
				</div>
			  </div>
			  <div class="form-group">
